...
const terms: Terms = {
  ...
  'abstract objects': 'every entity is either concrete or abstract; abstract entities that exist independently of human perception or spatiotemporal location. They are non-physical, non-mental, and not bound by time. Examples include numbers, sets, propositions, and fictional characters.',
  'ad hoc': 'means "for this" or "for this purpose". For the specific purpose, case, or situation at hand and for no other.',
  'analytic proposition': 'true or not true solely by virtue of their meaning where the predicate is already contained within the subject.',
  'analytic-synthetic distinction': 'a philosophical concept that differentiates between two types of truths: analytic and synthetic',
  ...
  'cartesian certainty': 'refers to the idea of achieving a foundational level of knowledge that is indubitable and beyond any reasonable doubt.',
  ...
  'ought': 'used to indicate duty or correctness, typically when criticizing someone\'s actions.; used to indicate something that is probable.',
  ...
  'Problem of Induction': 'a philosophical issue that questions the validity of inferring general conclusions from specific observations. Essentially, it asks how we can justify assuming that future events will resemble past ones, especially when our knowledge is based on limited past experiences.',
  ...
  'propter hoc': 'means "because of this"; It is often used in the context of the logical fallacy "post hoc ergo propter hoc," which translates to "after this, therefore because of this". This fallacy incorrectly assumes that because one event follows another, the first event caused the second',
  ...
  'underdetermination': 'the idea that the evidence available to support a scientific theory is often insufficient to uniquely determine that theory as the correct one,',

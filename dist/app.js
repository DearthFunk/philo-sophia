...
;// CONCATENATED MODULE: ./src/philosobabel.js
/*eslint-disable quote-props, max-len*/

/* harmony default export */ const philosobabel = ({
...
async function LoadTerms() {
  ...
  terms = Object.keys(philosobabel).map((k) => ({
    word: k,
    definition: philosobabel[k],
    foundWords: [],
  }));
  ...
  terms.forEach((item) => {
    let termsWords = Object.keys(philosobabel);
